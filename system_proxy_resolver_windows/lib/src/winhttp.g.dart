...
class WinHttpBindings {
  ...
  ffi.Pointer<
      ffi.NativeFunction<
          ffi.Void Function(
              ...
              ffi.UnsignedLong)>> WinHttpSetStatusCallback(
    HINTERNET hInternet,
    ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(HINTERNET, ffi.UnsignedLongLong,
  ...
  late final _WinHttpSetStatusCallbackPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.NativeFunction<ffi.Void Function(HINTERNET, ffi.UnsignedLongLong, ffi.UnsignedLong, ffi.Pointer<ffi.Void>, ffi.UnsignedLong)>> Function(
              HINTERNET,
              ffi.Pointer<
                  ffi.NativeFunction<
                      ffi.Void Function(
  ...
  late final _WinHttpSetStatusCallback = _WinHttpSetStatusCallbackPtr.asFunction<
      ffi.Pointer<ffi.NativeFunction<ffi.Void Function(HINTERNET, ffi.UnsignedLongLong, ffi.UnsignedLong, ffi.Pointer<ffi.Void>, ffi.UnsignedLong)>> Function(
          HINTERNET,
          ffi.Pointer<
              ffi.NativeFunction<
  ...
  late final _WinHttpOpen = _WinHttpOpenPtr.asFunction<
      HINTERNET Function(ffi.Pointer<ffi.WChar>, int, ffi.Pointer<ffi.WChar>,
          ffi.Pointer<ffi.WChar>, int)>();

  int WinHttpCreateProxyResolver(
    HINTERNET hSession,
    ffi.Pointer<HINTERNET> phResolver,
  ) {
  ...
  late final _WinHttpCreateProxyResolverPtr = _lookup<
      ffi.NativeFunction<
          ffi.UnsignedLong Function(HINTERNET,
              ffi.Pointer<HINTERNET>)>>('WinHttpCreateProxyResolver');
  late final _WinHttpCreateProxyResolver = _WinHttpCreateProxyResolverPtr
      .asFunction<int Function(HINTERNET, ffi.Pointer<HINTERNET>)>();
  ...
  late final _WinHttpGetProxyForUrlEx = _WinHttpGetProxyForUrlExPtr.asFunction<
      int Function(HINTERNET, ffi.Pointer<ffi.WChar>,
  ...
  late final _WinHttpGetIEProxyConfigForCurrentUser =
      _WinHttpGetIEProxyConfigForCurrentUserPtr.asFunction<
          bool Function(ffi.Pointer<WINHTTP_CURRENT_USER_IE_PROXY_CONFIG>)>();
}

/// types
typedef HINTERNET = ffi.Pointer<ffi.Void>;
...
class WINHTTP_AUTOPROXY_OPTIONS extends ffi.Struct {
  ...
  @ffi.Bool()
  external bool fAutoLogonIfChallenged;
}

class WINHTTP_CURRENT_USER_IE_PROXY_CONFIG extends ffi.Struct {
  @ffi.Bool()
  external bool fAutoDetect;
